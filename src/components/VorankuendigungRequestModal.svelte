<script type="ts">
    import {createVorankuendigungPayoutRequest, getBfsgPayoutRequestData} from "../util";
    import {token, vorankuendigungPayoutRequestData} from "../stores";
    ...
    const yeetRequest = () => {
        createVorankuendigungPayoutRequest(fsId, semesterId, category, amount_cents, status, status_date,
    ...
    const reloadPayoutRequestData = () => {
        getBfsgPayoutRequestData('vorankuendigung')
            .then(data => {
